...
function(detect_cuDNN)
  ...
  if(APPLE)
    set(FIND_CUDNN_LIBRARY_NAME "libcudnn.dylib")
  elseif(MSVC)
  ...
  set (FIND_CUDNN_LIBRARY_PATHS ${CUDNN_ROOT} $ENV{CUDNN_ROOT} ${CUDNN_INCLUDE} "${CUDNN_ROOT}/lib" "$ENV{CUDNN_ROOT}/lib" ${__libpath_hist} ${__libpath_hist}/../lib)
